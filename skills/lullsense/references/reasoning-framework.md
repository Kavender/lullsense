# Reasoning Framework — moved (tombstone)
...
- **Evidence transparency & honesty** → `references/evidence-rules.md`

The three invariants (never diagnose / preserve uncertainty & label heuristics / no fabrication) are Prime Directives in `SKILL.md`.

*Tombstone kept for one release so stale links don't 404. Update any pointer you find to the file above; then this file can be removed.*
