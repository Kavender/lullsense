...
- Decisions of record: D22 (passive safety net), D23 (emotional value), D24 (interaction spine), D25 (constraint-first), D26 (planful staged deliverables), D27 (meet-their-vocabulary) — `plan-do-not-commit/decisions-record-v2.md`.
