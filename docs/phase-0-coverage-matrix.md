...
| `independent_settling` | 8 | bedtime_routine_benefits, graduated_extinction_efficacy, behavioral_interventions_safety, medical_ruleout_before_behavioral, bedtime_fading, consistent_response_settling, independent_settling_readiness, sleep_associations_context | Strong: behavioral SRs + practice-parameter. |
